...
var app = new Vue({
  ...
  data: {
    ...
    linksFooter: ['Cardiology', 'Pediatrics', 'Diabetes Care', 'Pre-natel Care', 'Ultrasound Echocardiogram'],
    // Logo images paths
    logos: ["img/client-logos-1.png", "img/client-logos-2.png", "img/client-logos-3.png", "img/client-logos-4.png"]
  },
  methods: {
